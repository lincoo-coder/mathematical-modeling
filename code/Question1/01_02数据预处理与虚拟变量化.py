...
def preprocess_data():
    # 读取数据
    log("开始读取数据")
    athletes_df = pd.read_csv("../../data/第一问处理的数据/第一阶段/summerOly_athletes.csv")
    hosts_df = pd.read_csv("../../data/第一问处理的数据/第一阶段/summerOly_hosts.csv")
    medals_df = pd.read_csv("../../data/第一问处理的数据/第一阶段/处理过NOC的原版本medal数据.csv")
    programs_df = pd.read_csv("../../data/第一问处理的数据/第一阶段/summerOly_programs.csv")
